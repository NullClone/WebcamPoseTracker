...
namespace WPT
{
    ...
    sealed class ImageSourceEditor : Editor
    {
        ...
        SerializedProperty _video;
        SerializedProperty _videoPlayer;
        SerializedProperty _webcamName;
        SerializedProperty _webcamResolution;
        SerializedProperty _webcamFrameRate;
        SerializedProperty _camera;
        SerializedProperty _outputTexture;
        ...
        public override void OnInspectorGUI()
        {
            ...
            var type = (SourceType)_sourceType.enumValueIndex;
